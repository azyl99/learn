package com.example.a0_methodhandler;
...
public class MethodHandleDemo {
    public static void main(String[] args) throws Throwable {
        ...
        MethodHandle mh = lookup.findStatic(MethodHandleDemo.class, "doubleVal",
                MethodType.methodType(int.class, int.class));
        MethodHandle mhh = lookup.findStatic(MethodHandleDemo.class, "tripleVal",
                MethodType.methodType(int.class, int.class));
        List<Integer> dataList = Arrays.asList(1, 2, 3);

        // 这里是把方法做为参数的例子：
        MethodHandleDemo.transform(dataList, mh);
        ...
        // 用另一个方法作为参数
        MethodHandleDemo.transform(dataList, mhh);
        for (Integer data : dataList) {
            System.out.print(data + " ");
        }
