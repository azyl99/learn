...
//        PrintUtils.printArr(place);
        ...
        int res = -1;
        boolean bMouse = true;
        while (res == -1 && (res = test(set, place)) == -1) {
            if (bMouse) {
                res = mouse(dd, dr, graph, place);
            } else {
                res = cat(dd, dr, graph, place);
            }
//            PrintUtils.printArr(place);
            bMouse = !bMouse;
        }
    ...
    private int cat(int[][] dd, int[][] dr, int[][] graph, int[] place) {
        int m = place[0];
        int c = place[1];
    ...
    private int mouse(int[][] dd, int[][] dr, int[][] graph, int[] place) {
        int m = place[0];
        int c = place[1];
